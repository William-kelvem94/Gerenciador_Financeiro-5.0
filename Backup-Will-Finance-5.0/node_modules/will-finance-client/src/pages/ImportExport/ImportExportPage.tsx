...
const ImportExportPage: React.FC = () => {
  ...
  showError(`Tipo de arquivo não suportado. Use: ${allowedTypes.join(', ')}`);
      return;
    }
  ...
  showSuccess('Preview gerado com sucesso!');
      } else {
  ...
  showError(error instanceof Error ? error.message : 'Erro ao processar arquivo');
    } finally {
  ...
  showError('Nome da conta é obrigatório');
    ...
    try {
      ...
      if (result.success) {
        ...
        setPreviewData(null);
  showSuccess(`✅ ${result.stats.importedCount} transações importadas com sucesso!`);
  ...
  showError(error instanceof Error ? error.message : 'Erro na importação');
    } finally {
      setIsProcessing(false);
    }
  };
  ...
  showError(error instanceof Error ? error.message : 'Erro na exportação');
    } finally {
      setIsProcessing(false);
    }
  };
