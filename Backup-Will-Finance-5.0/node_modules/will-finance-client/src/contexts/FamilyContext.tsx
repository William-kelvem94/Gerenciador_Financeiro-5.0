...
export const FamilyProvider: React.FC<FamilyProviderProps> = ({ children }) => {
  ...
  showError('Erro ao carregar configurações familiares');
      }
    };
  ...
  showSuccess('Sistema familiar inicializado com usuários padrão!');
  };
  ...
  showSuccess(`Usuário ${newUser.name} adicionado com sucesso!`);
      return newUser;
    } catch (error) {
  ...
  showSuccess(`Usuário ${userToRemove.name} removido`);
      return true;
    } catch (error) {
  ...
  showSuccess(`Database ${newDatabase.displayName} criado!`);
      return newDatabase;
    } catch (error) {
  showError('Erro ao criar database');
      throw error;
    }
  };
  ...
  showSuccess('Database atualizado!');
      return true;
    } catch (error) {
  showError('Erro ao atualizar database');
      return false;
    }
  };
  ...
  showSuccess('Database removido');
      return true;
    } catch (error) {
  showError('Erro ao remover database');
      return false;
    }
  };
