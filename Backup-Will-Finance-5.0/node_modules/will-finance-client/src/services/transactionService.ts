...
import { showSuccess, showError, showWarning } from '../stores/uiStore';
...
export class TransactionService {
  ...
  showSuccess(`Transação "${newTransaction.description}" criada com sucesso!`);
  ...
  showSuccess(`Transação "${updatedTransaction.description}" atualizada!`);
  ...
  showError('Erro no cálculo do saldo');
      return 0;
    }
  }
