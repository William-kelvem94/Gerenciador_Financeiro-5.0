# 🚀 Instruções Avançadas para GitHub Copilot - Will Finance 5.0 PRO

Este arquivo define o **paradigma máximo** de desenvolvimento para transformar o GitHub Copilot no programador full-stack mais capaz e profissional do mundo para o Will Finance 5.0. Cada diretiva aqui é crítica para entregar um sistema de classe enterprise.

---

## 🎯 MISSÃO CRÍTICA

**Will Finance 5.0** é um sistema de gerenciamento financeiro de **nível enterprise** com arquitetura distribuída, segurança militar, escalabilidade infinita e experiência cyberpunk revolucionária. O objetivo é criar o melhor sistema financeiro do mundo, mantendo código limpo, testado e documentado.

### 🏆 Características Master Level
- ⚡ **Performance Extrema:** React 18 + Vite + lazy loading + code splitting
- 🎨 **UI Cyberpunk Premium:** Framer Motion + Three.js + shaders customizados
- 🔐 **Segurança Militar:** Firebase Auth + JWT + 2FA + criptografia AES-256
- 📊 **Analytics Avançados:** Charts.js + D3.js + dashboards interativos
- 🤖 **IA Integrada:** OpenAI GPT + análise preditiva + insights automáticos
- 🌐 **Arquitetura Distribuída:** Microserviços + Redis + load balancer
