...
export const bladeRunnerTheme: CyberpunkTheme = {
  ...
  colors: {
    ...
    chart: ['#00d4ff', '#ff0080', '#ffff00', '#00ff88', '#ff6600', '#8000ff', '#ff0040', '#00ffff'],
  },
  animations: {
    enabled: true,
    speed: 'normal',
...
export const cyberpunk2077Theme: CyberpunkTheme = {
  ...
  colors: {
    ...
    chart: ['#fcee09', '#00f5ff', '#ff003c', '#39ff14', '#ff8c00', '#9d00ff', '#ff1493', '#00ffff'],
  },
  animations: {
    enabled: true,
    speed: 'fast',
...
export const matrixTheme: CyberpunkTheme = {
  ...
  colors: {
    ...
    chart: ['#00ff41', '#00cc33', '#00ff88', '#66ff66', '#33ff33', '#99ff99', '#00aa22', '#44ff44'],
  },
  animations: {
    enabled: true,
    speed: 'normal',
...
export const ghostShellTheme: CyberpunkTheme = {
  ...
  colors: {
    ...
    chart: ['#ff00ff', '#8000ff', '#ff69b4', '#da70d6', '#9932cc', '#ba55d3', '#dda0dd', '#ee82ee'],
  },
  animations: {
    enabled: true,
    speed: 'normal',
