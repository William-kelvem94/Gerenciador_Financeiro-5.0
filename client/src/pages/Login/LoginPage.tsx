                ...
                <div className="space-y-2 text-center">
                  <div className="flex justify-center gap-2">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="rounded border border-green-400/30 bg-gray-800/40 px-3 py-1 font-mono text-xs text-green-400 transition-all hover:border-green-400/60 hover:text-green-300 disabled:opacity-50"
                    >
                      ✨ Criar admin
                    </button>
                  </div>
