...
export function LoginPage() {
  ...
  const createAdminIfNotExists = async () => {
    ...
    try {
      ...
      await register('Administrador do Sistema', 'admin@willfinance.com', 'admin123');
        ...
        <div className="relative bg-gray-900/90 backdrop-blur-xl border-2 border-cyan-400/40 rounded-2xl p-10 shadow-2xl">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {isRegisterMode && (
                <div>
                  <label htmlFor="name" className="block text-xs font-bold text-cyan-400 mb-2 uppercase tracking-wider">
                    👤 Nome Completo
                  </label>
              ...
              {!isRegisterMode && (
                <div className="text-center space-y-2">
                  <div className="flex gap-2 justify-center">
                    ...
                    <button
                      type="button"
                      onClick={createAdminIfNotExists}
                      disabled={loading}
                      className="text-xs text-green-400 hover:text-green-300 font-mono bg-gray-800/40 px-3 py-1 rounded border border-green-400/30 hover:border-green-400/60 transition-all disabled:opacity-50"
                    >
                      ✨ Criar admin
                    </button>
                  </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-400 text-xs font-mono">OU</span>
              <div className="flex-1 h-px bg-gray-600"></div>
            </div>
            ...
            <motion.button
              ...
              whileHover={{ scale: loading ? 1 : 1.02 }}
              whileTap={{ scale: loading ? 1 : 0.98 }}
              className="w-full bg-white text-gray-800 font-bold py-3 px-6 rounded-lg transition-all duration-300 disabled:opacity-70 text-sm shadow-lg hover:bg-gray-100 flex items-center justify-center space-x-2"
            >
            ...
            {!isRegisterMode && (
              <div className="bg-gray-800/40 rounded-lg p-4 border border-yellow-400/20">
                <div className="flex items-center justify-center space-x-2 mb-2">
                  ...
                  <span className="text-xs font-bold text-yellow-400 uppercase tracking-wider">Admin</span>
                </div>
