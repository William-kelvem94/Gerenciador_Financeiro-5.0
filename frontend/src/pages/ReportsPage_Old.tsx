...
const ReportsPage: React.FC = () => {
  ...
  const incomeVsExpenseData = [
    { month: 'Jan', receitas: 5000, despesas: 3200, economia: 1800 },
    { month: 'Fev', receitas: 5200, despesas: 3400, economia: 1800 },
    { month: 'Mar', receitas: 4800, despesas: 3600, economia: 1200 },
    { month: 'Abr', receitas: 5500, despesas: 3800, economia: 1700 },
    { month: 'Mai', receitas: 5100, despesas: 3200, economia: 1900 },
    { month: 'Jun', receitas: 5800, despesas: 3500, economia: 2300 },
  ];

  const budgetData = [
    { category: 'Alimentação', budget: 1000, spent: 850, percentage: 85 },
    { category: 'Transporte', budget: 400, spent: 320, percentage: 80 },
    { category: 'Lazer', budget: 300, spent: 180, percentage: 60 },
    { category: 'Compras', budget: 500, spent: 420, percentage: 84 },
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        ...
        >
          <ExpenseDistributionChart expenseDistributionData={data?.categoryBreakdown} />
