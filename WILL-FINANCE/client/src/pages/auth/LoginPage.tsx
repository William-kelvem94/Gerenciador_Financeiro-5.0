    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="bg-black/20 backdrop-blur-md border border-green-500/30 rounded-xl p-8 shadow-2xl">
          ...
          {/* Demo credentials */}
          <div className="mt-4 p-4 bg-black/20 border border-green-500/20 rounded-lg">
            <p className="text-xs text-gray-400 text-center mb-2">Credenciais de demonstração:</p>
            <p className="text-xs text-green-400 text-center">demo@willfinance.com / cyberpunk2077</p>
          </div>
        </div>
      </motion.div>
    </div>
