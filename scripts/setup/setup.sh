...
# Database
DATABASE_URL=postgresql://will_finance:CHANGE_THIS_PASSWORD@localhost:5432/will_finance_db

# JWT Secrets
JWT_SECRET=CHANGE_THIS_SECRET_KEY_IN_PRODUCTION
JWT_REFRESH_SECRET=CHANGE_THIS_REFRESH_SECRET_KEY_IN_PRODUCTION
